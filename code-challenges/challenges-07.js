...
const objLat = (obj) => {
    var fullname;
    fullname="my name is "+  obj.firstName.charAt(0).toUpperCase() +  obj.firstName.slice(1) +  " "+ obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1)+" I am "+ obj.age + " YO, and I love " + obj.hobby+"." ;
    return fullname;
};
// -------------------------------------------------------------------------------------------------------
...
let objc1 =new Object;
    if(arr[i].yearsOfExperience > 1){
          ...
          if(arr[i].lastName !=null ){
            ...
            objc1.fullName = arr[i].firstName +" "+ arr[i].lastName;}

        else {
            objc1.fullName = arr[i].firstName;
        }


        objc1.tech = arr[i].tech;
        arr1.push(objc1);
    }
}
